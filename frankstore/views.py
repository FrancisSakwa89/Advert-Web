...
from .forms import ProfileForm,NewAdvertForm
...
def profile(request, id):
  ...
  adverts = Advert.objects.filter(post=frank).order_by()
  advertcount=adverts.count()


  return render(request, 'profile.html',{'profile':profile,'user':user,'advertcount':advertcount,'adverts':adverts})
